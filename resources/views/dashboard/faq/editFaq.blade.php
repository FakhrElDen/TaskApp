...
<section class="contentWrapper__cover"><!--Start contentWrapper__cover-->
    ...
    <div class="contentWrapper__cover__blogging">
        <h4 class="cap-case color-blue">Edit FAQ</h4>
    </div>

    <form enctype="multipart/form-data" action="{{env('APP_URL')}}/updateFaq/{{ $faq->id }}" method="POST">
        {{ @csrf_field() }}
        ...
        <div class="contentWrapper__content__form__div">
            ...
            <textarea class="contentWrapper__cover__blogEdit editable" name="answer" cols="30" rows="10">{!! $faq->answer !!}</textarea>
        </div>
