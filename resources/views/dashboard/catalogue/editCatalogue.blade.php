    ...
    <section class="contentWrapper__cover"><!--Start contentWrapper__cover-->
        ...
        <div class="contentWrapper__content"><!--Start contentWrapper__content-->
            <div class="contentWrapper__content__form">
                ...
                <form enctype="multipart/form-data" action="{{env('APP_URL')}}/updateCatalogue/{{ $catalogue->id }}" method="POST">
                    {{ @csrf_field() }}
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text" value="{{ $catalogue->name }}" name="name" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text" value="{{ $catalogue->label }}" name="label" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text" value="{{ $catalogue->description }}" name="description" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text" value="{{ $catalogue->language }}" name="language" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text"  value="{{ $catalogue->catalogue_link }}" name="catalogue_link" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="text" value="{{ $catalogue->for }}" name="for" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <div class="contentWrapper__content__form__file">
                            <input type="text" value="{{ $catalogue->color }}" name="color" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="number" value="{{ $catalogue->discount }}" name="discount" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <input type="checkbox" {{ ($catalogue->responsive_switch) ? "checked" : "" }}  name="responsive_switch" class="form-control">
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <div class="contentWrapper__content__form__file">
                            ...
                            <span class="file__result">{{ $catalogue->desktop_image }}</span>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <div class="contentWrapper__content__form__file">
                            ...
                            <span class="file__result">{{ $catalogue->tablet_image }}</span>
                            <button class="file__btn color-white"><i class="fa fa-plus fa-fw"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="contentWrapper__content__form__div">
                        ...
                        <div class="contentWrapper__content__form__file">
                            ...
                            <span class="file__result">{{ $catalogue->mobile_image }}</span>
                            <button class="file__btn color-white"><i class="fa fa-plus fa-fw"></i></button>
                        </div>
                    </div>
