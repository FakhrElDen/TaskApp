...
@section('content')
    ...
    <div class="contentWrapper__content"><!--Start contentWrapper__content-->
        <div class="contentWrapper__content__form">
            ...
            <form action="{{env('APP_URL')}}/updateBenefit/{{$benefit->id}}" method="POST">
                {{ @csrf_field() }}
                ...
                <div class="contentWrapper__content__form__div">
                    ...
                    <input type="text" value="{{$benefit->name}}" name="name" id="" class="form-control">
                </div>
                <div class="contentWrapper__content__form__checks">
                    <label>
                        <input type="hidden" name="demand" value="NULL">
                        <input name="demand" type="checkbox" {{ ($benefit->demand) ? "checked" : "" }}> <span>On demand label</span>
