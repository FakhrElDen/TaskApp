...
@section('content')
    <div class="contentWrapper__content"><!--Start contentWrapper__content-->
        <div class="contentWrapper__content__form">
            ...
            <form enctype="multipart/form-data" action="{{env('APP_URL')}}/updateSquad/{{ $squad->id }}" method="POST">
                {{ @csrf_field() }}
                <div class="contentWrapper__content__form__div">
                    ...
                    <input type="text" value="{{ $squad->name }}" name="name" class="form-control">
                </div>
                ...
                <div class="contentWrapper__content__form__div">
                    ...
                    <input type="text" value="{{ $squad->position }}" name="position" class="form-control">
                </div>
                ...
                <div class="contentWrapper__content__form__div">
                    ...
                    <div class="contentWrapper__content__form__file">
                        <input type="file" value="{{ $squad->image }}" name="image" class="content__file" multiple>
                        <span class="file__result">{{ $squad->image }}</span>
